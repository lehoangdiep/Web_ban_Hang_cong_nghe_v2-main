...
<?php 
  ...
  $sql_selec1 = "SELECT * FROM tbl_loaisp WHERE id_loaisp = $id_danhmuc";
  $query_selec1 = mysqli_query($mysqli,$sql_selec1);
  $row_selec1 = mysqli_fetch_array($query_selec1);
         ...
         <div class="main4-content">
             ...
             <?php 
                ...
                while($row_sp1 = mysqli_fetch_array($query_sp1)){
                 ...
                 if($row_sp1['id_loaisp'] == $id_danhmuc && $row_sp1['tinhtrang']==1){
