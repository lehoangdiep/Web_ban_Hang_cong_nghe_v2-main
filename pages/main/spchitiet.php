<?php
    ...
    $sql_sp = "SELECT * FROM tbl_danhmucsp,tbl_brand,tbl_sanpham WHERE  tbl_danhmucsp.id_danhmuc = tbl_sanpham.id_danhmuc AND tbl_sanpham.id_brand = tbl_brand.id_brand AND  tbl_sanpham.id_sanpham = '$_GET[id_sanpham]'   LIMIT 1";
...
<?php
   ...
   while($row_sp = mysqli_fetch_array($query_sp)) {
     $new_price = $row_sp['giasp'] - ($row_sp['giasp'] * $row_sp['sale']/100);
     $sale_price = ($row_sp['giasp']*$row_sp['sale'])/100;
...
<div class="main-sp-all">
    <div class="clear"></div>
    <div class="url_sp">
        <p><a href="#"><?php echo $name_loaisp ?></a> / <a href="#"><?php echo $row_sp['tendanhmuc'] ?></a> / <a href="#"><?php echo $row_sp['tenbrand'] ?></a></p>
    </div>
  ...
  <div class="mySlides">
    <img src="RestaurantPOS/Restro/admin/assets/img/products/<?php echo $row_sp['hinhanh'] ?>" style="width:100%">
  </div>
  ...
  <div class="mySlides">
    <img src="RestaurantPOS/Restro/admin/assets/img/products2/<?php echo $row_picture2['img_product'] ?>" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="RestaurantPOS/Restro/admin/assets/img/products/<?php echo $row_sp['hinhanh'] ?>" style="width:100%;" onclick="currentSlide(1)" >
    </div>
...
<div class="column">
      <img class="demo cursor" src="RestaurantPOS/Restro/admin/assets/img/products2/<?php echo $row_picture2['img_product'] ?>" style="width:100%;" onclick="currentSlide(<?php echo $i+1 ?>)" >
    </div>
...
?>
          ...
          <form action="pages/main/themgiohang.php?idsanpham=<?php echo $row_sp['id_sanpham'] ?>" method="POST">
             <div class="main1_sp_right">
                 <div class="sp_line1">
                     <p>Mã SP: <span><?php echo $row_sp['masp'] ?></span>  | Số lượng có sẵn : <span><?php echo $row_sp['soluong'] ?> sản phẩm</span>  | Số lượng đã bán : <span><?php echo  $row_sp['luongmua'] ?> sản phẩm</span> </p>
                 </div>
                 <div class="sp_line2">
                 ...
                 <div class="sp_line3 ">
                     ...
                     <p><span class="box-new_price"><?php echo number_format(($new_price),0,',','.' ).' ₫'  ?></span> <span class="box-old_price"><del><?php echo number_format(($row_sp['giasp']),0,',','.' ).' ₫' ; ?></del> </span><span class="box_sale"> Tiết Kiệm: <?php echo number_format(($sale_price),0,',','.' ).' ₫' ; ?></span></p>
                     </div>
                 </div>
                 <?php if($row_sp['soluong'] > 0) {?>   
              ...
              <div class="main-sp-right-content">
                  ...
                  <?php  
                      ...
                      while($row_sp1 = mysqli_fetch_array($query_sp1)){
                         if($row_sp1['id_danhmuc'] == $row_sp['id_danhmuc']){
            ...
            <div class="user-comment-right">
              ...
              <div class="shop-box-comment">
                <div class="admin-avatar">
                  <img src="img/BanLogo.png" alt="" class="admin-img">
                </div>
                <div class="box-cmt">     
                  <div class="admin-name">
                    <a>Admin ElectricStore</a>  
                  </div>
                  <div class="admin-cmt">
                   <?php echo $row_comment_shop['noidung'] ?>
                  </div>
                  <div class="time-admin-cmt">
                    <?php echo $row_comment_shop['time_comment'] ?>
                  </div>
