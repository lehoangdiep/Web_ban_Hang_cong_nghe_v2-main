  ...
  <div class="profile-nav col-md-3">
      <div class="panel">
          <div class="user-heading round">
              <a >
                  <img src="RestaurantPOS/Restro/admin/assets/img/user/<?php echo $row_user_data['hinhanh'] ?>" alt="">
              </a>
          ...
          <div class="panel-body bio-graph-info">
              ...
              <div class="row">
                ...
                <div class="bio-row">
                  ...
                  <div class="bio-row">
                      <p><span>Thành phố  </span>: <?php echo $row_user_data['tinh'] ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Quận/Huyện  </span>: <?php echo $row_user_data['tp'] ?></p>
                  </div>
                  <div class="bio-row">
                      <p><span>Địa chỉ cụ thể</span>: <?php echo $row_user_data['diachicuthe'] ?>, <?php echo $row_user_data['tp'] ?>, <?php echo $row_user_data['tinh'] ?>(nơi nhận hàng)</p>
                  </div>
              ...
              <div class="col-md-6">
                  <div class="panel">
                      <div class="panel-body">
                          ...
                          <div class="bio-desk">
                              <h4 class="red">Đơn Hàng đã mua</h4>
                          </div>
                          <div>
                            <a href="index.php?quanly=lsdonhang&id_user=<?php echo $user_id  ?>">
